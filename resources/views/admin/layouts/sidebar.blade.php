    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
            ...
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{ url('admin/dash') }}"
                ...
                <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true">
                    <a href="{{ url('admin/user') }}" class="kt-menu__link ">
                        ...
                        <span class="kt-menu__link-text">User</span></a>
                </li>
                <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true">
                    <a href="{{ url('admin/student') }}" class="kt-menu__link ">
                        <span class="kt-menu__link-icon">
                        </span>
                        <span class="kt-menu__link-text">Student</span></a>
                </li>
                <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true">
                ...
                <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true">
                    <a href="{{ url('') }}" class="kt-menu__link ">
                        ...
                        <span class="kt-menu__link-text">Teacher</span></a>
                </li>
