...
class StudentController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.admin.student.create', compact('users', 'batches', 'faculties'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('backend.admin.student.show', compact('student', 'users', 'batches', 'faculties'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $users = User::all()->pluck('name', 'id');
        $student = Student::find($id);
        return view('backend.admin.student.edit', compact('student', 'batches', 'faculties', 'users'));
    }
